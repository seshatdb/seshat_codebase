...
vars_dic = {'Land_taxes_collected': {'model': Land_taxes_collected, 'list': Land_taxes_collectedListView, 'create': Land_taxes_collectedCreate}, 'Land_yield': {'model': Land_yield, 'list': Land_yieldListView, 'create': Land_yieldCreate}, 'Total_tax': {'model': Total_tax, 'list': Total_taxListView, 'create': Total_taxCreate}, 'Total_economic_output': {'model': Total_economic_output, 'list': Total_economic_outputListView, 'create': Total_economic_outputCreate}, 'Total_revenue': {'model': Total_revenue, 'list': Total_revenueListView, 'create': Total_revenueCreate}, 'Diding_taxes': {'model': Diding_taxes, 'list': Diding_taxesListView, 'create': Diding_taxesCreate}, 'Salt_tax': {'model': Salt_tax, 'list': Salt_taxListView, 'create': Salt_taxCreate}, 'Tariff_and_transit': {'model': Tariff_and_transit, 'list': Tariff_and_transitListView, 'create': Tariff_and_transitCreate}, 'Misc_incomes': {'model': Misc_incomes, 'list': Misc_incomesListView, 'create': Misc_incomesCreate}, 'Total_expenditure': {'model': Total_expenditure, 'list': Total_expenditureListView, 'create': Total_expenditureCreate}, 'Balance': {'model': Balance, 'list': BalanceListView, 'create': BalanceCreate}, 'Lijin': {'model': Lijin, 'list': LijinListView, 'create': LijinCreate}, 'Maritime_custom': {'model': Maritime_custom, 'list': Maritime_customListView, 'create': Maritime_customCreate}, 'Other_incomes': {'model': Other_incomes, 'list': Other_incomesListView, 'create': Other_incomesCreate}, 'Revenue_official': {'model': Revenue_official, 'list': Revenue_officialListView, 'create': Revenue_officialCreate}, 'Revenue_real': {
    'model': Revenue_real, 'list': Revenue_realListView, 'create': Revenue_realCreate}, 'Gdp_total': {'model': Gdp_total, 'list': Gdp_totalListView, 'create': Gdp_totalCreate}, 'Gdp_growth_rate': {'model': Gdp_growth_rate, 'list': Gdp_growth_rateListView, 'create': Gdp_growth_rateCreate}, 'Shares_of_world_gdp': {'model': Shares_of_world_gdp, 'list': Shares_of_world_gdpListView, 'create': Shares_of_world_gdpCreate}, 'Gdp_per_capita': {'model': Gdp_per_capita, 'list': Gdp_per_capitaListView, 'create': Gdp_per_capitaCreate}, 'Rate_of_gdp_per_capita_growth': {'model': Rate_of_gdp_per_capita_growth, 'list': Rate_of_gdp_per_capita_growthListView, 'create': Rate_of_gdp_per_capita_growthCreate}, 'Wages': {'model': Wages, 'list': WagesListView, 'create': WagesCreate}, 'Annual_wages': {'model': Annual_wages, 'list': Annual_wagesListView, 'create': Annual_wagesCreate}, 'Rate_of_return': {'model': Rate_of_return, 'list': Rate_of_returnListView, 'create': Rate_of_returnCreate}, 'Famine_event': {'model': Famine_event, 'list': Famine_eventListView, 'create': Famine_eventCreate}, 'Disease_event': {'model': Disease_event, 'list': Disease_eventListView, 'create': Disease_eventCreate}, 'Jinshi_degrees_awarded': {'model': Jinshi_degrees_awarded, 'list': Jinshi_degrees_awardedListView, 'create': Jinshi_degrees_awardedCreate}, 'Examination': {'model': Examination, 'list': ExaminationListView, 'create': ExaminationCreate}, 'Taiping_rebellion': {'model': Taiping_rebellion, 'list': Taiping_rebellionListView, 'create': Taiping_rebellionCreate}, 'Worker_wage': {'model': Worker_wage, 'list': Worker_wageListView, 'create': Worker_wageCreate}}
